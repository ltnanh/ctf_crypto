...
$$\begin{cases}
m_{0,0}h_0 + m_{0,1}h_1 + .... + m_{0,127}h_127 = E_0 \\
m_{1,0}h_0 + m_{1,1}h_1 + .... + m_{1,127}h_127 = E_1 \\
....... \\
m_{127,0}h_0 + m_{127,1}h_1 + .... + m_{127,127}h_127 = E_{127}
\end{cases}$$
...
$$\begin{cases}
m_{0,0}h_0 + m_{0,1}h_1 + .... + m_{0,127}h_127 = 0 \\
....... \\
m_{7,0}h_0 + m_{7,1}h_1 + .... + m_{7,127}h_127 = 0
\end{cases}$$
