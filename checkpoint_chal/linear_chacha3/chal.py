...
class LinearChaCha20:
    ...
    def generate_keystream(self, length, key, iv):
        ...
        for i in range(0, length, 64):
            ...
            # Toàn bộ phép cộng (+) đã được đổi thành XOR (^)
            for k in range(16):
...
if __name__ == '__main__':
    # Khởi tạo các giá trị bí mật
    k1 = os.urandom(32)
    k2 = os.urandom(32)
    iv1 = os.urandom(12)
    iv2 = os.urandom(12)

    flag = b"flag{du0_l1neAr_ch4ch4ch4_i5_N0t_s0_s3cur3}"
